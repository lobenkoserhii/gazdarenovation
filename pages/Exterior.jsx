...
function Exterior() {
  return (
      ...
      <div className=" max-w-[1440px] mx-auto">
        ...
        <img className="w-[518px] h-[346px] shadow" src="./exterior_p1.jpg" alt="Kichen" />
        <div>
      ...
      <div className="flex flex-col tablet:flex-row items-center justify-center my-[120px]">
        <div className="relative">
          <img className="w-[300px] h-[450px] shadow relative absolute top-0 left-[130px] z-10" src="./kitchen_p2.png" alt="Kichen" />
          <img className="w-[300px] h-[450px] shadow relative absolute top-[-80px] left-0 " src="./kitchen_p3.png" alt="Kichen" />
        </div>
