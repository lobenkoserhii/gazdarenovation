  ...
  return (
    <div className="mx-auto max-w-[1440px]">
      <div className="flex flex-col tablet:flex-row  items-center justify-center my-10 tablet:my-[120px]  tablet:mx-[100px]">
        <img className="w-[350px] tablet:w-[518px] tablet:h-[346px] shadow" src="./kitchen_p1.jpeg" alt="Kitchen" />
        <div>
      ...
      <div className="flex flex-col tablet:flex-row items-center justify-center my-10  tablet:my-[120px] ">
        <div className="relative">
          <img className="w-[300px] h-[450px] shadow tablet:relative flex flex-col tablet:absolute tablet:top-0 tablet:left-[130px] z-10" src="./kitchen_p2.png" alt="Kitchen" />
          <img className="w-[300px] h-[450px] shadow tablet:relative flex flex-col tablet:absolute tablet:top-[-80px] tablet:left-0 " src="./kitchen_p3.png" alt="Kitchen" />
        </div>
